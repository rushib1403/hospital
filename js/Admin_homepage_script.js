...
(function($) {
    ...
    $("#toggle-todays-app").click((e)=>{
        ...
        $("#dataTable-all-verify").css("display", "none");
    ...
    $("#toggle-all-verify").click((e)=>{
        e.preventDefault();
        $("#dataTable-today-app").css("display", "none");
        $("#dataTable-all-app").css("display", "none");
        $("#dataTable-all-verify").slideDown("slow","swing");
    });
    ...
    $("#all-verify-search").on("keyup", function(e){ 
        e.preventDefault();
        var value = $(this).val().toLowerCase();

        $("#all-verify-data tr").filter(function(){
            $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1);
        });
    });
